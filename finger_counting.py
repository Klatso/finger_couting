...
drawing_style = mp.solutions.drawing_utils.DrawingSpec(color=(52, 172, 76), thickness=1, circle_radius=1)
finger_points = {
   "Zeigefinger": (6, 8), 
   "Mittelfinger": (10, 12), 
   "Ringfinger": (14, 16), 
...
while True:
    ...
    if hands_result.multi_hand_landmarks is not None:
        ...
        for hand in hands_result.multi_hand_landmarks:
            finger_count = 0
            drawing.draw_landmarks(frame, hand, mp.solutions.hands.HAND_CONNECTIONS, drawing_style, drawing_style)
    ...
    cv2.putText(frame, f"{finger_count} Finger ausgestreckt!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (52, 172, 76), 2)
